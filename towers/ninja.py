...
class Ninja(towers.base_tower.Base_tower):
    def __init__(self, data: data_class.Data_class, tile_map_obj: tile_map.Tile_map, pos: tuple[int, int]) -> None:
        ...
        self.possible_upgrades: list[data_class.Upgrade_data] = [
            {"name": "sharper_shuriken", "cost": 260, "requirement": "", "y_pos": 0,  "is_master": False, "is_elite": False,
             "description": ["Sharper Shurikens"], "original_img": data.original_tower_images["upgrades"]["sharper_shuriken"], "img": pg.Surface((24,24))},
            {"name": "double_kill", "cost": 1000, "requirement": "sharper_shuriken", "y_pos": 0,  "is_master": True, "is_elite": False,
            ...
            {"name": "more_range", "cost": 100, "requirement": "", "y_pos": 2,  "is_master": False, "is_elite": False,
             "description": ["Bigger Range"], "original_img": data.original_tower_images["upgrades"]["more_range"], "img": pg.Surface((24,24))},
            {"name": "robot_assassin", "cost": 1100, "requirement": "shorter_cooldown", "y_pos": 1, "is_master": True, "is_elite": False,
            ...
            {"name": "shorter_cooldown", "cost": 190, "requirement": "", "y_pos": 1,  "is_master": False, "is_elite": False,
